                                ...
                                <div class="employee">
                                    ...
                                    <?php if ($eMeta['page_link']): ?>
                                        <div class="employee__about-link">
                                            <a class="link" href="<?= esc_url(get_permalink($eMeta['page_link'][0])) ?>"><?php if ($eMeta['name_predl'][0]): ?>об <?= $eMeta['name_predl'][0] ?><?php else: ?>о сотруднике<?php endif; ?><img src="/wp-content/themes/<?= get_template() ?>/assets/images/S_link.svg"></a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>

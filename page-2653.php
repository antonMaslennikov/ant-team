                    ...
                    <div class="faq__content">
                        ...
                        <ul class="collapsed">
                            ...
                            <li><span>Какие аудиты, кроме технического, вы можете предложить?<img src="/wp-content/themes/<?= get_template() ?>/assets/images/B_expand.svg"></span>
                                <div>Мы также проводим аудит коммерческих факторов конкурентов и аудит YMYL-факторов ранжирования. Оба аудита направлены на выявление слабых мест у вашего сайта, которые мешают получить высокие позиции. Вы также можете заказать их для получения комплексных рекомендаций по продвижению.</div>
                            </li>

                                ...
                                <div class="review__comment">
                                    ...
                                    <div class="review__rating">
                                        <div class="rating">
                                            ...
                                            <div class="rating__top-layer" style="width:70%"><img src="/wp-content/themes/<?= get_template() ?>/assets/images/star.svg"><img src="/wp-content/themes/<?= get_template() ?>/assets/images/star.svg"><img src="/wp-content/themes/<?= get_template() ?>/assets/images/star.svg"><img src="/wp-content/themes/<?= get_template() ?>/assets/images/star.svg"><img src="/wp-content/themes/<?= get_template() ?>/assets/images/star.svg"></div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="approach__wrapper">
                            ...
                            <div class="approach__graph"><img src="/wp-content/themes/<?= get_template() ?>/assets/images/seo.jpg"></div>
                        </div>
                    </div>
                </div>
            </div>

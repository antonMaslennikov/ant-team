                        ...
                        <div class="dop_services__item">
                            <div class="dop_service">
                                <div class="tariff__header">
                                    <h3 class="dop_service__title">Индивидуальные SEO-консультации</h3><span class="dop_service__price">от 5 000 ₽</span>
                                </div>
                                <div class="dop_service__content">
                                    <div class="dop_service__desc">Вам не нужно полноценное продвижение, а достаточно качественной консультации? Квалифицированные SEO-специалисты из Ant-Team.ru помогут вам в формате разового онлайн-созвона или предложат поддержку и кураторство в течение длительного времени!</div>
                                    <a class="btn btn-small dop_service__link" data-fancybox data-dop_service="Индивидуальные SEO-консультации" href="#modal-order-form">Заказать</a>
                                </div>
                            </div>
                        </div>
                        <div class="dop_services__item">

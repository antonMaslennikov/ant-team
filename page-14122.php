                            ...
                            <div class="check-list">
                                ...
                                <ul class="check-list__list">
                                    ...
                                    <li>
                                        ...
                                        Для товарной карточки можно проанализировать и выявить зависимость по таким параметрам: количество фото, наличие видео и 3D-обзоров, уникальное описание и его размер, пометка «есть/нет в наличии», рейтинг товара, наличие и объём отзывов, а также наличие в отзывах видео и фото, пометка «скидка/хит/популярное» и т. д. Всё это решается индивидуально.<br>
                                        Для страницы категории это могут быть такие параметры: количество товаров в категории и количество товаров отображаемых на странице пагинации, наличие рейтинга и оценок товара, пометки «скидка/хит/популярное/акция», размер названия товара и многие другие.<br>
                                    </li>
                                </ul>
                            </div>
                        </div>

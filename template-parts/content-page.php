    ...
    <div id="post-<?php the_ID(); ?>">
        <div class="article-content-wrapp">
            <div class="entry-content">
                ...
                wp_link_pages( array(
                    'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'ant-team-ru' ),
                    'after'  => '</div>',
                ) );
                ?>
            </div><!-- .entry-content -->
